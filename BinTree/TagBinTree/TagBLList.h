...
void InThread(TagBTNode *);
TagBTNode * CreateInThread(TagBTNode *);
void InThreadTravel(TagBTNode *);

void PreThread(TagBTNode *);
TagBTNode * CreatePreThread(TagBTNode *);
void PreThreadTravel(TagBTNode *);
